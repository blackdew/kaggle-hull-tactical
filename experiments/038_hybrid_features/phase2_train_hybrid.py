#!/usr/bin/env python3
"""
EXP-038 v3 Phase 2: Train Hybrid Model
Goal: Train EXP-020 strategy (Global Quantile XGBoost) using the Hybrid Feature Set (MSE + Quantile).
"""
import numpy as np
import pandas as pd
...
print("="*80)
print("EXP-038 v3 Phase 2: Train Hybrid Model")
print("="*80)
...
hybrid_df = pd.read_csv("experiments/038_hybrid_features/results/hybrid_features.csv")
...
print("RESULTS:")
print("="*80)
print(f"EXP-038 v3 CV Sharpe: {avg_sharpe:.4f} ± {std_sharpe:.4f}")
...
if avg_sharpe > 0.6368:
    print("✅ SUCCESS: Hybrid Feature Set improved performance!")
else:
...
results_df.to_csv("experiments/038_hybrid_features/results/cv_results_v3.csv", index=False)
print("\nResults saved to experiments/038_hybrid_features/results/")
