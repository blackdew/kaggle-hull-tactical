"""
EXP-025 Phase 1: 1D ResNet Baseline

Residual Blocks를 사용한 deep neural network
"""
...
print("="*80)
print("EXP-025 Phase 1: 1D ResNet Baseline")
print("="*80)
...
class ResidualBlock(nn.Module):
    ...
    def __init__(self, in_features, out_features, dropout=0.3):
        ...
        # Skip connection (adjust dimension if needed)
...
class ResNet1D(nn.Module):
    ...
    def __init__(self, input_dim=305, hidden_dims=[512, 256, 128, 64], dropout=0.3):
...
print("\n[2] Training 1D ResNet with 5-fold CV...")
...
# Comparison
baselines = {'EXP-016': 0.559, 'EXP-021': 0.637, 'EXP-024': 0.559}
print(f"\n📈 Comparison:")
...
# Save
output_path = Path("experiments/025/results/phase1_resnet_results.csv")
